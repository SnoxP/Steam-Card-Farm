              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 flex flex-col gap-6">
                  ...
                  <div className="bg-[#10151c] border border-[#1d2630] rounded-lg overflow-hidden flex flex-col">
                    ...
                    <div className={`p-6 grid grid-flow-col max-md:auto-cols-[85%] md:auto-cols-[calc(50%-8px)] lg:auto-cols-[300px] xl:auto-cols-[350px] overflow-x-auto gap-4 custom-scrollbar-blue pb-6 ${((status?.activeAppIds?.length || 0) + (status?.pausedGames?.length || 0)) >= 2 ? 'grid-rows-2' : 'grid-rows-1'}`}>
